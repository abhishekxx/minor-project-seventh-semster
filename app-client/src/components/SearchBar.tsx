  ...
  return (
    ...
    >
      ...
      <div className="flex gap-1">
        <button className="w-2/3 h-full p-2 text-xl font-bold text-white rounded-md bg-gradient-to-r from-blue-700 to-blue-500">
          Search
        </button>
        <button className="w-1/3 h-full p-2 text-xl font-bold text-white transition-colors rounded-md bg-gradient-to-r from-red-500 to-red-400">
          Clear
        </button>
      </div>
    </form>
